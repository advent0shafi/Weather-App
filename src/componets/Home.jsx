...
function Home() {
  ...
  return (
    <div>
      ...
      <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-96 rounded-md first-letter p-5 shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>
        <div className=''>
          ...
          <div className='flex justify-center items-center relative'>
            <input
              ...
              className="p-2 mt-2 w-full bg-slate-300"
              value={city}
              onChange={handleCityChange}
            />

            <button className="bg-slate-900 p-2.5 text-white mt-2" onClick={handleSubmit}>
              <CiSearch size={20} />
            </button>
          </div>
        </div>
